...
import de.tuberlin.aura.core.filesystem.FileStatus;
import de.tuberlin.aura.core.filesystem.FileSystem;
import de.tuberlin.aura.core.filesystem.Path;
...
public class LocalFileStatus implements FileStatus {
	...
	/**
	 * Creates a <code>LocalFileStatus</code> object from a given {@link java.io.File} object.
	 * 
	 * @param f
	 *        the {@link java.io.File} object this <code>LocalFileStatus</code> refers to
	 * @param fs
