...
import de.tuberlin.aura.util.ClassUtils;
import de.tuberlin.aura.util.OperatingSystem;
import de.tuberlin.aura.util.StringUtils;
...
abstract public class FileSystem {
    ...
    private static final String LOCAL_FILESYSTEM_CLASS = "de.tuberlin.aura.core.fs.local.LocalFileSystem";

    /*private static final String DISTRIBUTED_FILESYSTEM_CLASS = "de.tuberlin.aura.runtime.fs.hdfs.DistributedFileSystem";

    private static final String S3_FILESYSTEM_CLASS = "de.tuberlin.aura.runtime.fs.s3.S3FileSystem";*/
