...
import de.tuberlin.aura.core.filesystem.FSDataInputStream;
...
public class LocalDataInputStream extends FSDataInputStream {
	...
	/**
	 * Constructs a new <code>LocalDataInputStream</code> object from a given {@link java.io.File} object.
	 * 
	 * @param file
	 *        the {@link java.io.File} object the data stream is written to
