...
public class HadoopRecordReader {
	...
	public static class FileSource extends AbstractInvokeable {

		private final RowRecordWriter recordWriter;

		public FileSource(final ITaskDriver taskDriver, final IDataProducer producer, final IDataConsumer consumer, final Logger LOG) {
