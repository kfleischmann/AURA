...
public final class TaskManager implements ITaskManager {
    ...
    private ITaskDriver registerTask(final Descriptors.DeploymentDescriptor deploymentDescriptor) {
        ...
        final ITaskDriver taskDriver = new TaskDriver(this, deploymentDescriptor, new TaskInputSplitProvider(deploymentDescriptor.nodeDescriptor, globalInputSplitProvider ));
